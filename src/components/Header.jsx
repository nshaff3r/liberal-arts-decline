...
import { headlinesm, headlinelg, subhead, byline } from '../../public/content.js';
...
const Header = ({ windowWidth, windowHeight }) => {
    return (
        <div className="w-full h-[100vh] relative">
            ...
            One of the many jam circles that formed during the workshop.{' '} </p> */}
            <a href="https://chicagomaroon.com/staff_name/nolan-shaffer/">Nolan Shaffer</a>.
            {/* </p> */}
